...
def encodeHandler():
    ...
    writer = cv.VideoWriter("C:/Users/rakes/Desktop/Steganography/Video-steganography/frontend/public/output.mp4", apiPreference=0, fourcc=fourcc,fps=video_fps[0], frameSize=(width, height))
    ...
    while(True):
        ...
        if frame_number > starting_frame and frame_number < 100:
...
def decodeHandler():
    ...
    vid.set(1,starting_frame)
    ret, frame = vid.read()
    img_pil = Image.open("gray.png", 'r')
    # print(type(img_pil))
    # print(type(frame))
    # img_pil = Image.fromarray(frame)
    # if img_pil == insertedframe : 
    #     print("img_pil == insertedframe") 
    # elif frame == insertedframe :
    #     print("frame == insertedframe")
    # elif img_pil == insertedframetwo :
    #     print("img_pil == insertedframetwo")
    # elif img_pil == insertedframetwo :
    #     print("img_pil == insertedframetwo")
    # print(type(img_pil))
    # img_pil.save("temp.png")
    # img_pil = Image.open("temp.png", 'r')
    # print(type(img_pil))
    print(decode(img_pil))
